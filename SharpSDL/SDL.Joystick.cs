...
namespace SharpSDL
{
    public static partial class SDL
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe int SDL_JoystickGetBall(SDL_Joystick joystick, int ball, int* dx, int* dy);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe byte* SDL_JoystickName(SDL_Joystick joystick);
